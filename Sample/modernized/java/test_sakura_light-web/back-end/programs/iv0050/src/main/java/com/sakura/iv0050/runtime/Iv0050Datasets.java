package com.sakura.iv0050.runtime;
...
/**
 * Shared file instances for program: IV0050 Mirrors COBOL's single FD per SELECT — ensures
 * consistent file state.
 */
@Component
@Scope("prototype")
public class Iv0050Datasets extends AbstractDatasets {

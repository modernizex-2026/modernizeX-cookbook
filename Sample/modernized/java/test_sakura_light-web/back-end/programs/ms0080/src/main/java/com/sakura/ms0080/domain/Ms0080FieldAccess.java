package com.sakura.ms0080.domain;

import com.sakura.ms0080.runtime.Ms0080Datasets;
import com.sakura.runtime.record.RuntimeFieldAccess;

/**
 * Field accessor for MS0080. Backend: RuntimeFieldAccess (raw RecordImage byte[]). Typed methods
 * auto-generated from referenced fields — bodies delegate to the string-key API.
 */
public class Ms0080FieldAccess extends RuntimeFieldAccess {

    public Ms0080FieldAccess(WorkingStorage ws, Ms0080Datasets fileSet) {
        if (ws != null) {
            register(ws.buffer());
        }
    ...
    public int getDpParent() {
        return getInt("DP-PARENT");
    }

    public void setDpParent(int value) {
        setInt("DP-PARENT", value);
    }

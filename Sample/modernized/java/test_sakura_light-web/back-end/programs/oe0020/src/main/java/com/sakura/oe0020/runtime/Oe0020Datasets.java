package com.sakura.oe0020.runtime;
...
/**
 * Shared file instances for program: OE0020 Mirrors COBOL's single FD per SELECT — ensures
 * consistent file state.
 */
@Component
@Scope("prototype")
public class Oe0020Datasets extends AbstractDatasets {

package com.sakura.ap0020.runtime;
...
/**
 * Shared file instances for program: AP0020 Mirrors COBOL's single FD per SELECT — ensures
 * consistent file state.
 */
@Component
@Scope("prototype")
public class Ap0020Datasets extends AbstractDatasets {

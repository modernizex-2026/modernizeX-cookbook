package com.sakura.rp0060.runtime;
...
/**
 * Shared file instances for program: RP0060 Mirrors COBOL's single FD per SELECT — ensures
 * consistent file state.
 */
@Component
@Scope("prototype")
public class Rp0060Datasets extends AbstractDatasets {

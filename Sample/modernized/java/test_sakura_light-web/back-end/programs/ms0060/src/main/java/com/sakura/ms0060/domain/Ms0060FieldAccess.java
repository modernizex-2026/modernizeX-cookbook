package com.sakura.ms0060.domain;

import com.sakura.ms0060.runtime.Ms0060Datasets;
import com.sakura.runtime.record.RuntimeFieldAccess;

/**
 * Field accessor for MS0060. Backend: RuntimeFieldAccess (raw RecordImage byte[]). Typed methods
 * auto-generated from referenced fields — bodies delegate to the string-key API.
 */
public class Ms0060FieldAccess extends RuntimeFieldAccess {

    public Ms0060FieldAccess(WorkingStorage ws, Ms0060Datasets fileSet) {
        if (ws != null) {
            register(ws.buffer());
        }
    ...
    public int getCtDelFlag() {
        return getInt("CT-DEL-FLAG");
    }

    public void setCtDelFlag(int value) {
        setInt("CT-DEL-FLAG", value);
    }
    ...
    public int getCtParent() {
        return getInt("CT-PARENT");
    }

    public void setCtParent(int value) {
        setInt("CT-PARENT", value);
    }
    ...
    public String getWkParentName() {
        return getString("WK-PARENT-NAME");
    }

    public void setWkParentName(String value) {
        setString("WK-PARENT-NAME", value);
    }

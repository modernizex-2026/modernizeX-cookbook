...
/**
 * Field accessor for MS0070. Backend: RuntimeFieldAccess (raw RecordImage byte[]). Typed methods
 * auto-generated from referenced fields — bodies delegate to the string-key API.
 */
public class Ms0070FieldAccess extends RuntimeFieldAccess {

    public Ms0070FieldAccess(WorkingStorage ws, Ms0070Datasets fileSet) {
        if (ws != null) {
            register(ws.buffer());
        }
    ...
    public int getWkSaveCust() {
        return getInt("WK-SAVE-CUST");
    }

    public void setWkSaveCust(int value) {
        setInt("WK-SAVE-CUST", value);
    }

    public int getWkSaveProd() {
        return getInt("WK-SAVE-PROD");
    }

    public void setWkSaveProd(int value) {
        setInt("WK-SAVE-PROD", value);
    }

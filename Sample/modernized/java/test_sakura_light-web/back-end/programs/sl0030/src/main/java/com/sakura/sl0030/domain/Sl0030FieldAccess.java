package com.sakura.sl0030.domain;
...
/**
 * Field accessor for SL0030. Backend: RuntimeFieldAccess (raw RecordImage byte[]). Typed methods
 * auto-generated from referenced fields — bodies delegate to the string-key API.
 */
public class Sl0030FieldAccess extends RuntimeFieldAccess {

    public Sl0030FieldAccess(WorkingStorage ws, Sl0030Datasets fileSet) {
        if (ws != null) {
            register(ws.buffer());
        }

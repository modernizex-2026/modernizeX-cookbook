package com.sakura.ms0110.domain;

import com.sakura.ms0110.runtime.Ms0110Datasets;
import com.sakura.runtime.record.RuntimeFieldAccess;

/**
 * Field accessor for MS0110. Backend: RuntimeFieldAccess (raw RecordImage byte[]). Typed methods
 * auto-generated from referenced fields — bodies delegate to the string-key API.
 */
public class Ms0110FieldAccess extends RuntimeFieldAccess {

    public Ms0110FieldAccess(WorkingStorage ws, Ms0110Datasets fileSet) {
        if (ws != null) {
            register(ws.buffer());
        }
    ...
    public int getRgDelFlag() {
        return getInt("RG-DEL-FLAG");
    }

    public void setRgDelFlag(int value) {
        setInt("RG-DEL-FLAG", value);
    }

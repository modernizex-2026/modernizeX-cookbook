package com.sakura.ms0040.domain;

import com.sakura.ms0040.runtime.Ms0040Datasets;
import com.sakura.runtime.record.RuntimeFieldAccess;

/**
 * Field accessor for MS0040. Backend: RuntimeFieldAccess (raw RecordImage byte[]). Typed methods
 * auto-generated from referenced fields — bodies delegate to the string-key API.
 */
public class Ms0040FieldAccess extends RuntimeFieldAccess {

    public Ms0040FieldAccess(WorkingStorage ws, Ms0040Datasets fileSet) {
        if (ws != null) {
            register(ws.buffer());
        }
    ...
    public String getWhAddr() {
        return getString("WH-ADDR");
    }

    public void setWhAddr(String value) {
        setString("WH-ADDR", value);
    }
    ...
    public String getWhTel() {
        return getString("WH-TEL");
    }

    public void setWhTel(String value) {
        setString("WH-TEL", value);
    }
    ...
    public String getWhZip() {
        return getString("WH-ZIP");
    }

    public void setWhZip(String value) {
        setString("WH-ZIP", value);
    }
    ...
    public String getWkMgrName() {
        return getString("WK-MGR-NAME");
    }

    public void setWkMgrName(String value) {
        setString("WK-MGR-NAME", value);
    }

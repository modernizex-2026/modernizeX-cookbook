package com.sakura.rp0040.runtime;
...
/**
 * Shared file instances for program: RP0040 Mirrors COBOL's single FD per SELECT — ensures
 * consistent file state.
 */
@Component
@Scope("prototype")
public class Rp0040Datasets extends AbstractDatasets {

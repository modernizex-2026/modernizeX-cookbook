package com.sakura.iv0030.runtime;
...
/**
 * Shared file instances for program: IV0030 Mirrors COBOL's single FD per SELECT — ensures
 * consistent file state.
 */
@Component
@Scope("prototype")
public class Iv0030Datasets extends AbstractDatasets {

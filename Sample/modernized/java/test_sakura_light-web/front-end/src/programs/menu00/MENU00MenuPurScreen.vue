  ...
  <div class="scr-page">
    ...
    <div class="scr-page-sticky-top">
      <div class="scr-header">
        <div class="scr-header-left">          <h1 class="scr-title">PURCHASING</h1>
    ...
    <div class="scr-page-body">
      <div class="scr-form-section" style="display:grid; grid-template-columns:1fr 1fr; gap:8px;">
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('1')">1. Purchase Order Entry</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('2')">2. Purchase Order Inquiry</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('3')">3. Receiving</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('4')">4. Purchase Entry</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('5')">5. Purchase Return</button>

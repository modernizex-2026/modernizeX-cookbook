  ...
  <div class="scr-page">
    ...
    <div class="scr-page-sticky-top">
      <div class="scr-header">
        <div class="scr-header-left">          <h1 class="scr-title">MAIN MENU</h1>
    ...
    <div class="scr-page-body">
      <div class="scr-form-section" style="display:grid; grid-template-columns:1fr 1fr; gap:8px;">
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('1')">1. Master Maintenance</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('2')">2. Order / Sales</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('3')">3. Purchasing</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('4')">4. Inventory</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('5')">5. Receivable / Payable</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('6')">6. Reports</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('7')">7. Batch / Closing</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('0')">0. Sign off</button>
      </div>

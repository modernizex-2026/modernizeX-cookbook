  ...
  <div class="scr-page">
    ...
    <div class="scr-page-sticky-top">
      <div class="scr-header">
        <div class="scr-header-left">          <h1 class="scr-title">MASTER MAINTENANCE</h1>
    ...
    <div class="scr-page-body">
      <div class="scr-form-section" style="display:grid; grid-template-columns:1fr 1fr; gap:8px;">
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('1')">1. Customer</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('2')">2. Supplier</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('3')">3. Product</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('4')">4. Warehouse</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('5')">5. Staff</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('6')">6. Category</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('7')">7. Customer Price</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('8')">8. Department</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('9')">9. Tax Rate</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('10')">10. Bank</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('11')">11. Region</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('12')">12. User</button>

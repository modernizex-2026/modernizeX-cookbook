  ...
  <div class="scr-page">
    ...
    <div class="scr-page-sticky-top">
      <div class="scr-header">
        <div class="scr-header-left">          <h1 class="scr-title">ORDER / SALES</h1>
    ...
    <div class="scr-page-body">
      <div class="scr-form-section" style="display:grid; grid-template-columns:1fr 1fr; gap:8px;">
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('1')">1. Order Entry</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('2')">2. Order Inquiry</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('3')">3. Order Allocation</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('4')">4. Shipping</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('5')">5. Sales Entry</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('6')">6. Sales Inquiry</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('7')">7. Sales Return</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('8')">8. Order Maintenance</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('9')">9. Sales Credit Note</button>
          <button class="btn btn-outline" style="text-align:left; justify-content:flex-start; width:100%;" @click="selectOption('10')">10. Order Ack Print</button>

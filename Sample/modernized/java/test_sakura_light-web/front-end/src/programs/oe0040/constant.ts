...
export const NUMERIC_FIELDS = new Set<string>(['WK-SEL-ORD', 'WK-CMD-ARG', 'OH-DATE', 'OH-CUST', 'OH-STAFF', 'OH-WHSE', 'OH-DUE-DATE', 'OH-TAX-TYPE', 'WK-D-PROD', 'WK-D-WHSE', 'WK-D-QTY', 'WK-D-PRICE']);
...
export const HINTS: Record<string, string> = {
  'WK-CMD': 'Line: A=Add C=Chg D=Del H=Hdr X=Cxl S=Save',
  'WK-CMD-ARG': 'A=Add C=Chg D=Del H=Hdr X=Cxl S=Save',

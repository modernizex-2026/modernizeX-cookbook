...
const INPUTS = ['WK-KEY-PROD', 'WK-KEY-WHSE'];
const FIELD_DATA_MAP: Record<string, string> = {
  'WK-KEY-PROD': 'WK-KEY-PROD',
  'WK-KEY-WHSE': 'WK-KEY-WHSE',
};
const NUMERIC = new Set<string>(['WK-KEY-PROD', 'WK-KEY-WHSE']);
...
const { isFieldActive, activeWidth, valueOf, submit, onKey, onInput, bindActiveInput } =
  useScreenForm(props, {
    ...
    buildScreenValues: () => ({ 'WK-KEY-PROD': valueOfCache('WK-KEY-PROD'), 'WK-KEY-WHSE': valueOfCache('WK-KEY-WHSE') }),
    pfOverrides: {},

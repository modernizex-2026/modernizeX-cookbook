...
const INPUTS = ['WK-ORIG-INV'];
const FIELD_DATA_MAP: Record<string, string> = {
  'WK-ORIG-INV': 'WK-ORIG-INV',
};
const NUMERIC = new Set<string>(['WK-ORIG-INV']);
    ...
    <template #body>
      <div>
        <div class="scr-form-grid" style="align-items:start; grid-template-columns:100px 1fr;">
          <label class="scr-label" style="text-align:left; padding-top:9px; font-size:13px;">Original Invoice#</label>

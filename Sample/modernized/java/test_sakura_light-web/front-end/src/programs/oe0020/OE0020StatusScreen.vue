...
const { valueOf, submit } = useScreenForm(props, { pfOverrides: { F3: '03', F5: '05', F6: '06' }, typed });
...
<template>
  <Modal :visible="true" title="" min-width="560px" max-width="90vw" :close-able="false">
    ...
    <template #footer>
      ...
      <Button variant="outline" size="md" label="(F5)" @click="submit('', '05')" />
